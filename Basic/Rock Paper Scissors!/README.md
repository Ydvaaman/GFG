<h2><a href="https://practice.geeksforgeeks.org/problems/rock-paper-scissors2830/0">Rock Paper Scissors!</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">The RPS world championship is here. Here two players A and B play the game. You need to determine who wins.<br>
