<h2><a href="https://practice.geeksforgeeks.org/problems/count-alphabets3649/0">Count Alphabets</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string, The task is to count the number of&nbsp;alphabets present in the string.</span></p>
